  ...
  <section id="education" style={{ backgroundColor: '#FFFFFF', padding: '5rem 2rem' }}>
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
        ...
        <h2 style={{ fontFamily: "'Poppins', sans-serif", fontSize: 'clamp(2rem, 4vw, 2.8rem)', fontWeight: '800', color: '#2161a1', margin: '0 0 1rem', letterSpacing: '-0.3px' }}>
        ...
        {credentials.map((cred, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Title */}
              <h3 style={{ fontSize: '15px', fontWeight: '700', color: '#2161a1', margin: '0 0 0.5rem', lineHeight: '1.35' }}>
                {cred.title}
              </h3>
...
export const ContactSection = () => {
  ...
  return (
    <section id="connect" style={{ backgroundColor: '#e4ebeb', padding: '6rem 2rem', position: 'relative', overflow: 'hidden' }}>
      {/* Cursor-style decorative ring */}
      <div style={{ position: 'absolute', top: '2.5rem', left: '2.5rem', width: '52px', height: '52px', borderRadius: '50%', border: '2px solid #C9A84C', opacity: 0.2, pointerEvents: 'none' }} />

      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        {/* Heading */}
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          <h2 style={{ fontFamily: "'Poppins', sans-serif", fontSize: 'clamp(2rem, 4vw, 2.8rem)', fontWeight: '800', color: '#2161a1', margin: '0 0 0.875rem', letterSpacing: '-0.3px' }}>
        ...
        <div className="connect-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', alignItems: 'stretch' }}>
          ...
          <div style={{ backgroundColor: '#FFFFFF', border: '1.5px solid #E5E7EB', borderRadius: '16px', padding: '2.25rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginBottom: '2rem' }}>
              <h3 style={{ fontSize: '22px', fontWeight: '800', color: '#2161a1', margin: '0 0 0.3rem' }}>Mishant Gandhi</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: '13.5px', fontWeight: '600', color: '#2161a1', lineHeight: '1.3', wordBreak: 'break-word' }}>{value}</div>
                    </div>
                  </Tag>
                );
              })}
            ...
            <a
              ...
              style={{
                ...
                width: '44px', height: '44px', borderRadius: '10px',
                backgroundColor: '#2161a1', textDecoration: 'none',
                transition: 'background-color 0.3s ease, transform 0.2s ease',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#C9A84C'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#2161a1'; e.currentTarget.style.transform = 'translateY(0)'; }}
            >
          ...
          <div style={{ backgroundColor: '#FFFFFF', border: '1.5px solid #E5E7EB', borderRadius: '16px', padding: '2.25rem', display: 'flex', flexDirection: 'column' }}>
            {submitted ? (
              <div style={{ textAlign: 'center', padding: '3rem 1rem', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <h3 style={{ fontSize: '20px', fontWeight: '700', color: '#2161a1', margin: '0 0 0.5rem' }}>Message Sent!</h3>
                ...
                <button onClick={() => { setSubmitted(false); setForm({ name: '', email: '', phone: '', message: '' }); }}
                  style={{ backgroundColor: '#2161a1', color: '#FFFFFF', border: 'none', padding: '11px 28px', borderRadius: '50px', fontSize: '13.5px', fontWeight: '600', cursor: 'pointer', fontFamily: "'Poppins', sans-serif" }}>
                  Send Another
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem', flex: 1 }}>
                {/* Name */}
                <div>
                  <label style={{ display: 'block', fontSize: '13.5px', fontWeight: '600', color: '#2161a1', marginBottom: '6px' }}>Your Name</label>
                  <input type="text" placeholder="Enter your name" value={form.name}
                    ...
                    onFocus={(e) => (e.target.style.borderColor = '#2161a1')}
                ...
                <div className="form-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '13.5px', fontWeight: '600', color: '#2161a1', marginBottom: '6px' }}>Email Address</label>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '13.5px', fontWeight: '600', color: '#2161a1', marginBottom: '6px' }}>Contact Number</label>
                ...
                {/* Message */}
                <div>
                  <label style={{ display: 'block', fontSize: '13.5px', fontWeight: '600', color: '#2161a1', marginBottom: '6px' }}>Your Message</label>
                ...
                <button type="submit" data-testid="contact-submit" style={{
                  ...
                  backgroundColor: '#2161a1', color: '#FFFFFF',
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#C9A84C'; e.currentTarget.style.color = '#2161a1'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
                  onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#2161a1'; e.currentTarget.style.color = '#FFFFFF'; e.currentTarget.style.transform = 'translateY(0)'; }}
                >
                  Send Message
                </button>
              </form>

          ...
          <div style={{ backgroundColor: '#FFFFFF', border: '1.5px solid #E5E7EB', borderRadius: '16px', padding: '2.25rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <a
              ...
              style={{
                ...
                backgroundColor: '#003554', borderRadius: '12px',
                padding: '14px 18px', textDecoration: 'none',
                transition: 'transform 0.2s ease, box-shadow 0.2s ease',
                marginTop: '0.5rem',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(0,53,84,0.2)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}
            >
              <div style={{ width: '40px', height: '40px', borderRadius: '10px', backgroundColor: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              ...
              <div>
                <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '1.5px', fontWeight: '600', marginBottom: '2px' }}>WhatsApp</div>
                <div style={{ fontSize: '14px', fontWeight: '600', color: '#FFFFFF' }}>Message me directly</div>
              </div>
            </a>

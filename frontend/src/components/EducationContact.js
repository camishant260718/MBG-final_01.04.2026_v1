  ...
  <section id="education" style={{ backgroundColor: '#FFFFFF', padding: '5rem 2rem' }}>
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
        ...
        <h2 style={{ fontFamily: "'Poppins', sans-serif", fontSize: 'clamp(2rem, 4vw, 2.8rem)', fontWeight: '800', color: '#0F2244', margin: '0 0 1rem', letterSpacing: '-0.3px' }}>
        ...
        {credentials.map((cred, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Title */}
              <h3 style={{ fontSize: '15px', fontWeight: '700', color: '#0F2244', margin: '0 0 0.5rem', lineHeight: '1.35' }}>
                {cred.title}
              </h3>
...
export const ContactSection = () => {
  ...
  return (
    <section id="connect" style={{ backgroundColor: '#F8F9FB', padding: '6rem 2rem', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        {/* Heading */}
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          <h2 style={{ fontFamily: "'Poppins', sans-serif", fontSize: 'clamp(2rem, 4vw, 2.8rem)', fontWeight: '800', color: '#0F2244', margin: '0 0 0.875rem', letterSpacing: '-0.3px' }}>
        ...
        <div className="connect-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', alignItems: 'stretch' }}>
          ...
          <div style={{ backgroundColor: '#FFFFFF', border: '1.5px solid #E5E7EB', borderRadius: '16px', padding: '2.25rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <a
              ...
              onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#0F2244'; e.currentTarget.style.transform = 'translateY(0)'; }}
            >
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem', flex: 1 }}>
                ...
                <button type="submit" data-testid="contact-submit" style={{
                  ...
                  onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#0F2244'; e.currentTarget.style.color = '#FFFFFF'; e.currentTarget.style.transform = 'translateY(0)'; }}
                >
                  Send Message
                </button>
              </form>
